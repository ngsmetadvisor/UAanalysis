...
Original file is located at
    https://colab.research.google.com/drive/1B-_tNjHPVDgB9Wh6mdHVz7Au-fAnXsqs
"""
...
if not SKIP:
    ...
    try:
        ...
        FAILURE_LOG_DIR  = '/content/drive/MyDrive/synoptic_map'
...
display(Javascript(f"""
  ...
  document.querySelector('#output-area, .output, .jp-OutputArea-output')
    ? (document.querySelector('#output-area, .output, .jp-OutputArea-output')).appendChild(iframe)
